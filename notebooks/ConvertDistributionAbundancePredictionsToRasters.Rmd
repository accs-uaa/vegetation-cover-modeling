...
list_range = 1:2
# Define input folder
prediction_folder = 'K:/VegetationEcology/Data_Harmonization/Project_GIS/Data_Output/predictions/test/'
# Define output folder
raster_folder = 'K:/VegetationEcology/Data_Harmonization/Project_GIS/Data_Output/rasters/test/'
```
