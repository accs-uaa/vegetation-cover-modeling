...
list_range = 1:28
# Define input folder
prediction_folder = '/home/twnawrocki_rstudio/modelResults/area_prediction/predictions/'
# Define output folder
raster_folder = '/home/twnawrocki_rstudio/modelResults/area_prediction/rasters/'
```
...
convertPredictions = function(input_data, output_raster) {
  ...
  writeRaster(outlier_raster, output_raster, format='HFA')
}
```
