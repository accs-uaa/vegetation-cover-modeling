...
var landsatFiltered = landsat8TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2013, 2017, 'year')).filter(ee.Filter.calendarRange(6, 6, 'month'));
...
Export.image.toDrive({
  ...
  description: '06June_1_ultraBlue',
  scale: 30,
...
Export.image.toDrive({
  ...
  description: '06June_5_nearInfrared',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: '06June_6_shortInfrared1',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: '06June_7_shortInfrared2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
