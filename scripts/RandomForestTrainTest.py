# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Random Forest Train and Test for Classified Cover
...
test_data = arcpy.GetParameterAsText(1)
...
output_report = arcpy.GetParameterAsText(6)
...
def trainTestModel(x_train, y_train, x_test, y_test, testData, variable, outROCFile, outVariableFile):
    ...
    arcpy.AddMessage("Calculating optimal probability threshold...")
    i = 1
    ...
    arcpy.AddMessage("Exporting plots...")
...
arcpy.AddMessage("Converting feature classes to dataframes...")
...
arcpy.AddMessage("Plotting Pearson correlation of predictor variables...")
...
arcpy.AddMessage("Training and testing the 0 Classifier...")
...
arcpy.AddMessage("Training and testing the 25 Classifier...")
